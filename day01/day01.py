...
hree numbers in your expense report that meet the same criteria.
...
def cartesian_product(items: list, times=1) -> list:
    return itertools.product(items, repeat=times)


def solve_part1(expenses: list) -> int:
    for num1, num2 in cartesian_product(expenses, times=2):
        if num1 + num2 == 2020:
            return num1 * num2

test_expenses = [1721, 979, 366, 299, 675, 1456]
assert solve_part1(test_expenses) == 514579


def solve_part2(expenses: list) -> int:
    for num1, num2, num3 in cartesian_product(expenses, times=3):
        if num1 + num2 + num3 == 2020:
            return num1 * num2 * num3

test_expenses = [1721, 979, 366, 299, 675, 1456]
assert solve_part2(test_expenses) == 241861950


with open('input.txt') as f:
    expenses = [int(line.strip()) for line in f]
    part1 = solve_part1(expenses)
    part2 = solve_part2(expenses)
